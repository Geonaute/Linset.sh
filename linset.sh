...
function handshakelocation {
	...
	infoap
	echo
	echo -e "Introduzca la ruta del handshake que desea auditar (Ej: $rojo/root/micaptura.cap$rescolor)"
	echo -e "Pulsar ${amarillo}ENTER$rescolor para omitir"
	echo
	echo -n "ruta: "
	echo -ne "$rojo"
	read handshakeloc
...
function deauthforce {
	...
	while true; do
		...
		echo "                                       "
		echo -e "      "$verde"1)"$rescolor" Normal (Posibilidades de fallo)"
		echo -e "      "$verde"2)"$rescolor" Estricto"
		echo -e "      "$verde"3)"$rescolor" Atras"
		echo "                                       "
		echo -n "      #> "
		read yn
...
CwABBAAAAAAEAAAAAFBLBQYAAAAAAwADABIBAAAKVwIAAAA=
